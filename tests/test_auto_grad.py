...
def test_gaussian_backend_auto_grad():
    ...
    r_s1 = torch.tensor([1.0], requires_grad=True)
    r_s2 = torch.tensor([1.0], requires_grad=True)
    r_d1 = torch.tensor([1.0], requires_grad=True)
    r_d2 = torch.tensor([1.0], requires_grad=True)
