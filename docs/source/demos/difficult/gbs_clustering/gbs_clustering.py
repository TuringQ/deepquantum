...
# %% [markdown]
# 与此同时，高斯玻色采样也可以应用于聚类算法[3]， 根据GBS稠密子图案例的讨论可知高斯玻色采样用于图问题时， 图密度较大的子图对应的样本往往有较大概率被采到， 这些子图的节点对应的数据点就属于同一个聚类，因此通过这种方法就完成了一次聚类，然后将这个聚类对应的子图移除，继续高斯玻色采样过程，可以持续的找到多个不同的聚类。
...
#     <img src="./images/f1.png" width="60%"/>
