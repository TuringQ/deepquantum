...
#     <img src="./images/bs.png" width="30%"/>
...
#
# $$
# \langle n_1,n_2,...,n_N|W|\psi\rangle = \frac{\mathrm{Perm}(U_{st})}{\sqrt{m_1!...m_N!n_1...n_N!}}
# $$
#
# 输出的概率可以写成
#
# $$
# |\langle n_1,n_2,...,n_N|W|\psi\rangle|^2 = \frac{|\mathrm{Perm}(U_{st})|^2}{m_1!...m_N!n_1...n_N!}
# $$
#
...
#
# <div style="margin-right: 15px; border-radius: 10px; background-color: rgb(255， 255， 255); text-align: center;">
#     <img src="./images/f3.png" width="30%"/>
#     <p style="padding: 10px; font-size: small; text-align: center; line-height: 0%;">
#     </p>
# </div>
#
