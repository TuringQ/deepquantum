...
# $$   b \cdot 11 = 0   $$
#
# 这告诉我们 $b \neq 01$ 或 $10$，剩下的两个可能的解是 $b = 00$ 或 $b = 11$。请注意，$b = 00$ 将始终是我们联立方程的一个平凡解。如果我们重复步骤 1-6 多次，我们只会测量到 $|00\rangle$ 或 $|11\rangle$，因为 $b \cdot 11 = 0$ 和 $b \cdot 00 = 0$  是满足 $b=11$ 的唯一方程。我们可以通过选择一个随机输入（$x_i$）并检查 $f(x_i) = f(x_i \oplus b)$ 来验证 $b=11$。例如：
#
#  $$   01 \oplus b = 10   $$
#
#  $$   f(01) = f(10) = 11   $$
